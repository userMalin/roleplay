...
local ProfesjaDr = "Kucharz";
local ProfesjaOnFile = PROFESSION.KUCHARZ;
...
////////////////////////////////////////////////////////////
    ...
    kraftowa_lista = [
        {level =  1, nazwa = "Ser", czas = 60, craft = addCraft([ ["ITFO_MILK",1] ],[ ["ITFO_CHEESE",1] ])},
        {level =  1, nazwa = "Chleb", czas = 60, craft = addCraft([ ["ITPL_WEED",3],["ITPL_BEET", 1] ],[ ["ITFO_BREAD",1] ])},
        {level =  30, nazwa = "Sma¿one Miêso", czas = 30, craft = addCraft([ ["ITFOMUTTONRAW",1] ],[ ["ITFOMUTTON",1] ])},
    ];
